...
//         {
//             List<Customer> entityFromDb = await _genericRepo.Customers.Get(x => x.Deleted == DateTime.MinValue, null, x => x, Order => Order.OrderBy(x => x.Id)).ToListAsync();
...
//             var fromDb = await _genericRepo.Customers.Get(x => x.CompanyId == id && x.Deleted == DateTime.MinValue).ToListAsync();
...
//             var fromDb = await _genericRepo.Customers.GetPaged(
//                                          parameters,
...
//                 fromDb = await _genericRepo.Customers.GetPaged(
//                                                         parameters,
//                                                         predicate => predicate.CompanyId == parameters.predicate && predicate.Deleted == DateTime.MinValue,
//                                                         toInclude => toInclude.Include(x => x.Contact)
//                                                         .Include(x => x.Address),
...
//                 fromDb = fromDb = await _genericRepo.Customers.GetPaged(
//                                 parameters,
//                                 predicate => predicate.CompanyId == parameters.predicate && predicate.Deleted == DateTime.MinValue,
//                                 toInclude => toInclude.Include(x => x.Contact),
//                                 selector => selector,
...
//             var entityFromDb = await _genericRepo.Customers.GetById(
...
//         {
//             var entityFromDb = await _genericRepo.Customers.Get(
