...
public class CommonObjectMapper : ICommonObjectMapper
{
    ...
    public ContactDto ContactMapper(Contact entity)
    {
        ...
        var obj = ContactDto.Create(entity.Id, null, entity.CompanyId, entity.Deleted, entity.Registered, entity.Email, entity.Site, entity.Cel, entity.Zap,entity.Landline, SocialNetworkListMake(entity.SocialMedias));
