...
public class AuthController : ControllerBase
{
    ...
    public async Task<IActionResult> UpdateUserAccountAuthAsync([FromBody] UserAccountDto userAccountUpdate, int id) => Ok(await _ServiceLaucherService.AccountManagerServices.UpdateUserAccountAuthAsync(userAccountUpdate, id));
